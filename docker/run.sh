...
IMAGE_TAG="$(whoami)_tripo"
CONTAINER_NAME=tripo
CONTAINER_NAME="$CONTAINER_NAME_$(whoami)"
...
DOCKER_OPTIONS+="-e TRIPOSR_DIR=/home/$(whoami)/$(basename $(readlink -f $SCRIPT_DIR/../)) "
